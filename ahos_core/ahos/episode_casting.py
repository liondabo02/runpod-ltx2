...
def _human_voice_instruction(
    *,
    ...
    if age_years is not None and age_years <= 5:
        ...
        base = (
            f"Fictional adult {gender} voice for the role of {role}. Natural conversational "
            "delivery, distinct but realistic timbre, clear diction and emotionally appropriate "
            "performance. Do not imitate any real person."
        )
